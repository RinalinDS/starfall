export const Star = ({ rating = 0 }: { rating: number }) => {
  const size = 80 + 3 * rating;
  return (
    <div className="dar:text-amber-500 absolute right-1/2 bottom-[85%] left-1/2 flex flex-col items-center justify-center text-amber-600">
      <svg
      ...
      <div className="absolute text-[2rem] text-gray-900 dark:text-gray-50">
        {rating || '?'}
      </div>
    </div>
  );
